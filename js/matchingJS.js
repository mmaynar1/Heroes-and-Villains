...
var images = [ "img/stormtrooper.png", "img/masterchief.png", "img/spiderman.png", "img/venom.png", "img/ironman.png",
						"img/stormtrooper.png", "img/masterchief.png", "img/spiderman.png", "img/venom.png", "img/ironman.png", 
						"img/stormtrooper.png", "img/masterchief.png", "img/spiderman.png", "img/venom.png", "img/ironman.png", 
						"img/stormtrooper.png", "img/masterchief.png", "img/spiderman.png", "img/venom.png", "img/ironman.png" ];
...
$("span").click(function()
{
	...
	{
		$('#' + id1).children("img").attr("src", "img/questionmark.png");
		$('#' + id2).children("img").attr("src", "img/questionmark.png");
		id1 = "";
		id2 = "";
		reset = 0;
		matched = 0;
